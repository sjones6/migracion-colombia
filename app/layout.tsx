...
export const metadata: Metadata = {
  ...
  description:
    "Easily find which migracion locations have available appointments",
};
      ...
      >
        <nav className="flex flex-row justify-between border-b border-gray-700">
          ...
          <div className="flex-grow flex flex-row justify-end gap-4 p-8">
            <a
              className="bg-white hover:text-gray-900 active:text-gray-900 py-1 px-3 text-gray-600 hover:ring ring-white ring-offset-2 rounded flex flex-row gap-2 align-items-center"
